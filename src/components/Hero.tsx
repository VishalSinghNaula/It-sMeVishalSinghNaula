  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center px-4 py-20 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[hsl(200,100%,60%)]/10 rounded-full blur-3xl animate-float" style={{ animationDelay: "1s" }}></div>
      </div>
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8 relative z-10">
        ...
        <div className="flex flex-wrap gap-4 justify-center items-center animate-slide-up" style={{ animationDelay: "0.3s" }}>
          <Button size="lg" className="gap-2 bg-gradient-to-r from-accent to-[hsl(200,100%,60%)] hover:shadow-[0_0_30px_rgba(138,94,255,0.4)] transition-all duration-300 hover:scale-105 border-0">
            <Mail className="w-4 h-4" />
            <a
            href="mailto:vishalnaula@gmail.com"
             >Let's Connect</a>
          </Button>
          <Button variant="outline" size="lg" className="gap-2 border-2 hover:border-accent hover:text-accent transition-all duration-300 hover:scale-105">
            View My Work
          </Button>
        </div>

        <div className="flex gap-4 justify-center pt-4 animate-slide-up" style={{ animationDelay: "0.4s" }}>
          <a
